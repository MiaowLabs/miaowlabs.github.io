...
学习下面这种建立工程的方法，为了程序的规范和可读性。

很多同学会问：“为什么还要学新建工程，我以前都是建一个文件夹，然后再建C文件，把所有H文件包含进去。”其实，每个人有每个人的习惯，上面的建立工程习惯也是可以的。我在这里给大伙分享的是这种新建工程的方式，更加适合于平常的工作项目，可能对于初学者来说还不是那么容易接受。但是，学会了这种建立工程的分类方式，对初学者以后进行实战项目，会有很大的帮忙。

## 获取IAP15头文件

在开始讲解如何新建工程前，我们先来了解下如何获取IAP15的头文件。
